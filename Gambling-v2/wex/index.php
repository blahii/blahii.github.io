    ...
    <div class="chart-pie__wrapper">
      ...
      <div class="file-list">
        ...
        <div class="file-item ui-card ui-card--shadow">
          ...
          <span class="file-name">HTML: <h4><?php echo $counter->total_html(); ?></p> </span>
        </div>
        <!-- css -->
        <div class="file-item ui-card ui-card--shadow">
          ...
          <span class="file-name">CSS: <h4><?php echo $counter->total_css(); ?></p> </span>
        </div>
        <!-- js -->
        <div class="file-item ui-card ui-card--shadow">
          ...
          <span class="file-name">JS: <h4><?php echo $counter->total_js(); ?></p> </span>
        </div>
        <!-- img -->
        <div class="file-item ui-card ui-card--shadow">
          ...
          <span class="file-name">IMG: <h4><?php echo $counter->total_img(); ?></p> </span>
        </div>
        <!-- backups -->
        <div class="file-item ui-card ui-card--shadow">
          ...
          <span class="file-name"><?php echo $lang['backups']; ?>: <h4><?php echo $counter->total_backup(); ?></p> </span>
        </div>
        <!-- backups creater -->
        <div class="file-item ui-card ui-card--shadow">
